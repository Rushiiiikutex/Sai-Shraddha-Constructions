...
export default function Footer() {
  ...
  return (
    <footer id="contact" className="bg-slate-900 pt-20 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20">
          ...
          <div id="about">
            ...
            <h2 className="mt-3 text-3xl sm:text-4xl font-black text-white uppercase tracking-tight">
              Let&apos;s Build Together
            </h2>
            <div className="mt-4 w-16 h-1 bg-orange-500" />

            <p className="mt-8 text-slate-400 leading-relaxed max-w-md">
              SolidState Construction has been serving the community for over 20
            ...
            <div className="mt-10 space-y-5">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-lg text-white font-bold group-hover:text-orange-500 transition-colors">(555) 123-4567</p>
                </div>
              </a>

              <a
                href="mailto:info@solidstate.com"
                className="flex items-center gap-4 group"
              >
                <div className="w-12 h-12 bg-slate-800 rounded-sm flex items-center justify-center group-hover:bg-orange-500 transition-colors duration-300">
                  <svg className="w-5 h-5 text-orange-500 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  ...
                  <p className="text-lg text-white font-bold group-hover:text-orange-500 transition-colors">info@solidstate.com</p>
                </div>
              </a>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-lg text-white font-bold">1234 Builder&apos;s Way, Suite 100</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            <div className="bg-slate-800 rounded-sm p-8 sm:p-10 shadow-xl">
              ...
              <form onSubmit={handleSubmit} className="mt-8 space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-white text-slate-900 text-sm font-medium px-4 py-3 rounded-sm border-0 focus:outline-none focus:ring-2 focus:ring-orange-500 placeholder:text-slate-400 transition-shadow"
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-white text-slate-900 text-sm font-medium px-4 py-3 rounded-sm border-0 focus:outline-none focus:ring-2 focus:ring-orange-500 transition-shadow appearance-none"
                  >
        ...
        <div className="mt-16 pt-8 border-t border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-slate-500 text-xs">
            &copy; {new Date().getFullYear()} SolidState Construction. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
